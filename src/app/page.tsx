...
const projects = [
  {
    id: 1,
    title: "AI anime MV",
    description: "캐릭터의 외형 및 세계관 설정부터 기획, 제작까지 전 과정을 단독으로 수행하여, AI 도구를 활용한 2분 길이의 애니메이션 뮤직비디오를 제작하였습니다.\n\n‘노력하는 자의 꿈은 이루어진다’는 메시지를 전달하기 위해 희망차고 경쾌한 음악의 분위기에 맞춰 캐릭터와 스토리를 기획했습니다.\n\nNanobanana Pro를 활용해 장면 간 시각적 일관성을 유지한 비주얼을 제작하고, Premiere Pro를 통해 리듬감 있는 컷 편집과 인서트 활용으로 자연스러운 장면 전환을 구현했습니다. 이를 통해 AI 기반 제작 워크플로우를 경험하고 콘텐츠 제작 가능성을 확장했습니다.",
    tools: ["Premiere Pro"],
    aiTools: [
