...
// 1. ?¬íŠ¸?´ë¦¬???°ì´??êµ¬ì¡° (?ìƒ ?‘ì—…ë¬?ì¤‘ì‹¬)
const projects = [
  {
    id: 1,
    title: "AI anime MV",
    description: "ë³??ìƒ?€ ìºë¦­?°ì˜ ?¸ëª¨?€ ?¸ê³„ê´€ ?¤ì •ë¶€??ê¸°íš, ?œì‘ê¹Œì? ??ê³¼ì •???¼ì ì§„í–‰?˜ì—¬ AI ?„êµ¬ë¥??œìš©???œì‘??2ë¶?ê¸¸ì´??? ë‹ˆë©”ì´??ë®¤ì§ë¹„ë””?¤ì…?ˆë‹¤.\n\n?¬ë§ì°¨ê³  ? ë‚˜???Œì•…??ë¶„ìœ„ê¸°ì— ë§ëŠ” ìºë¦­?°ë? ê¸°íš?˜ê³ , ?˜ë…¸?¥í•˜???ì˜ ê¿ˆì? ?´ë£¨?´ì§„?¤â€™ëŠ” ë©”ì‹œì§€ë¥??´ì? ?¤í† ë¦¬ë? ê¸°ë°˜?¼ë¡œ ?Œì•…ê³??ìƒ???œì‘?ˆìŠµ?ˆë‹¤. AI ê¸°ë°˜ ?´ë?ì§€ ?ì„±ê³??ìƒ ?œì‘ ?„êµ¬ë¥??œìš©?˜ì—¬ ?¥ë©´??êµ¬ì„±?˜ê³  ?¸ì§‘???˜ë‚˜??? ë‹ˆë©”ì´??ë®¤ì§ë¹„ë””?¤ë¡œ ?„ì„±?ˆìŠµ?ˆë‹¤.\n\në³??‘ì—…???µí•´ AI ê¸°ìˆ ???œìš©??ì½˜í…ì¸??œì‘ ê³¼ì •ê³?ì°½ì‘ workflowë¥?ê²½í—˜?˜ê³ , AI ê¸°ë°˜ ?ìƒ ì½˜í…ì¸??œì‘ ê°€?¥ì„±???êµ¬?˜ê³ ???ˆìŠµ?ˆë‹¤.",
    tools: ["Premiere Pro"],
    aiTools: [
    ...
    thumbnailUrl: "/GIFs/?¸ë„¤??.jpg",
    gifs: ["/GIFs/1-1.mp4", "/GIFs/1-2.mp4", "/GIFs/1-3.mp4", "/GIFs/1-4.mp4"],
  },
  {
    id: 2,
    title: "Spotify on Naver\nëª¨ì…˜ê·¸ë˜???ìƒ",
    description: "ë³??ìƒ?€ ?¤ì´ë²?ë©¤ë²„??— ?ˆë¡­ê²?ì¶”ê????œíƒ??Spotify ?œë¹„?¤ë? ì£¼ì œë¡??œì‘??ëª¨ì…˜ê·¸ë˜???ìƒ?…ë‹ˆ??\n\n?¬ë§ì°¨ê³  ? ë‚˜???Œì•…??ë¶„ìœ„ê¸°ì— ë§ëŠ” ìºë¦­?°ë? ê¸°íš?˜ê³ , ?˜ë…¸?¥í•˜???ì˜ ê¿ˆì? ?´ë£¨?´ì§„?¤â€™ëŠ” ë©”ì‹œì§€ë¥??´ì? ?¤í† ë¦¬ë? ê¸°ë°˜?¼ë¡œ ?Œì•…ê³??ìƒ???œì‘?ˆìŠµ?ˆë‹¤. AI ê¸°ë°˜ ?´ë?ì§€ ?ì„±ê³??ìƒ ?œì‘ ?„êµ¬ë¥??œìš©?˜ì—¬ ?¥ë©´??êµ¬ì„±?˜ê³  ?¸ì§‘???˜ë‚˜??? ë‹ˆë©”ì´??ë®¤ì§ë¹„ë””?¤ë¡œ ?„ì„±?ˆìŠµ?ˆë‹¤.\n\në³??‘ì—…???µí•´ AI ê¸°ìˆ ???œìš©??ì½˜í…ì¸??œì‘ ê³¼ì •ê³?ì°½ì‘ workflowë¥?ê²½í—˜?˜ê³ , AI ê¸°ë°˜ ?ìƒ ì½˜í…ì¸??œì‘ ê°€?¥ì„±???êµ¬?˜ê³ ???ˆìŠµ?ˆë‹¤.",
  ...
  {
    id: 3,
    title: "ê¼¬ë‹¬ë¦?AI ê´‘ê³  ?ìƒ",
    description: "ë³??ìƒ?€ AI ?´ë?ì§€ ?ì„± ?„êµ¬??Midjourneyë¥??œìš©?˜ì—¬ ?œì‘???”ì¥??ê´‘ê³  ?ìƒ?…ë‹ˆ??\n\n?„ë‘?¤ì˜ ?´ì¶”??ë·°í‹° ë¸Œëœ??'Caudalie(ê¼¬ë‹¬ë¦?'??ë¸Œëœ???´ë?ì§€ë¥?ë¶„ì„?˜ì—¬ ?ì—° ì¹œí™”?ì¸ ì½˜ì…‰?¸ë? ì¤‘ì‹¬?¼ë¡œ ê´‘ê³  ?ìƒ??ê¸°íš?ˆìŠµ?ˆë‹¤. ?¹íˆ ë¸Œëœ?œì˜ ?µì‹¬ ?±ë¶„???¬ë„?˜ë¬´ ì¶”ì¶œë¬¼ì„ ?œê°?ìœ¼ë¡?ê°•ì¡°?˜ëŠ” ?°ì¶œ???µí•´ ?ì—° ? ë˜ ?±ë¶„???¬ìš©?˜ëŠ” ë¸Œëœ???„ì´?´í‹°?°ë? ?œí˜„?˜ê³ ???ˆìŠµ?ˆë‹¤.\n\nAI ê¸°ë°˜ ?´ë?ì§€ ?ì„± ê¸°ìˆ ???œìš©?˜ì—¬ ?ì—°?ì¸ ì§ˆê°ê³?ë¶„ìœ„ê¸°ë? ê°•ì¡°???¥ë©´???œì‘?˜ê³  ?´ë? ?ìƒ?¼ë¡œ êµ¬ì„±?˜ì—¬ ?”ì¥??ê´‘ê³  ì½˜í…ì¸ ë? ?„ì„±?ˆìŠµ?ˆë‹¤.",
  ...
  {
    id: 4,
    title: "AI ê³µëª¨??ê´‘ê³  ?ìƒ",
    description: "ë³??ìƒ?€ ????ë§¤ê²½ë¯¸ë””??AI ?ìƒ ê´‘ê³ Â·?í¼ ê³µëª¨?„ì— ì¶œí’ˆ?˜ê¸° ?„í•´ ?œì‘??AI ?ìƒ ê´‘ê³ ?…ë‹ˆ??\n\nê³µëª¨??ì£¼ì œ??ë§ì¶° ?œêµ­???€?œí•˜???Œì‹??ì¹˜í‚¨???Œì¬ë¡??œêµ­?ì„œ ?¸ê³„ë¡?ë»—ì–´?˜ê????¤í† ë¦¬ë? ì¤‘ì‹¬?¼ë¡œ ?ìƒ??ê¸°íš?ˆìŠµ?ˆë‹¤. AI ?ìƒ ?œì‘ ê¸°ìˆ ???œìš©?˜ì—¬ ì¹˜í‚¨ ë¸Œëœ?œê? ê¸€ë¡œë²Œ ?œì¥?¼ë¡œ ?•ì¥?˜ëŠ” ê³¼ì •???¤í† ë¦??•ì‹???ìƒ?¼ë¡œ ?œí˜„?˜ê³ ???ˆìŠµ?ˆë‹¤.",
    tools: ["Premiere Pro"],
    aiTools: [
  ...
  },
  {
    id: 5,
    title: "?¤ë„¤???€?´í¬ê·¸ë˜???ìƒ",
    description: "ë³??ìƒ?€ PLAVE???˜BBUU!???¸ë˜ë¥?ê¸°ë°˜?¼ë¡œ ?œì‘???¤ë„¤???€?´í¬ê·¸ë˜???ìƒ?…ë‹ˆ??\n\nê³¡ì´ ê°€ì§€ê³??ˆëŠ” ë°ê³  ê·€?¬ìš´ ë¶„ìœ„ê¸°ë? ? ì??˜ë©´??ê°€?¬ì? ?Œì•…??ë¦¬ë“¬??ë§ì¶˜ ?€?´í¬ê·¸ë˜??ëª¨ì…˜??ì¤‘ì‹¬?¼ë¡œ ?ìƒ??êµ¬ì„±?ˆìŠµ?ˆë‹¤. ?¹íˆ ë°˜ë³µ?˜ëŠ” ê°€??êµ¬ê°„??ì§€ë£¨í•˜ê²??ê»´ì§€ì§€ ?Šë„ë¡??¤ì–‘??ëª¨ì…˜ê³??œí˜„ ë°©ì‹???œìš©??ë¦¬ë“¬ê°??ˆëŠ” ?¥ë©´???œì‘?˜ëŠ” ??ì§‘ì¤‘?ˆìŠµ?ˆë‹¤.\n\n?¸ë˜???œí¬?€ ë¶„ìœ„ê¸°ì— ?´ìš¸ë¦¬ëŠ” ?€?´í¬ê·¸ë˜???€ì§ì„???µí•´ ?Œì•…???ë„ˆì§€ë¥??œê°?ìœ¼ë¡??œí˜„?˜ê³ ???ˆìŠµ?ˆë‹¤.",
    tools: ["Premiere Pro", "After Effects"],
  ...
  {
    id: 6,
    title: "ë©”ì´?ŒìŠ¤? ë¦¬ 23ì£¼ë…„\n?¸í¬ê·¸ë˜???ìƒ",
    description: "ë³??ìƒ?€ ê²Œì„ ë©”ì´?ŒìŠ¤? ë¦¬ 23ì£¼ë…„ ?´ë²¤?¸ë? ì£¼ì œë¡??œì‘???•ë³´ ?„ë‹¬ ì¤‘ì‹¬???¸í¬ê·¸ë˜???ìƒ?…ë‹ˆ??\n\n?´ë²¤???´ìš©???¬ìš©?ì—ê²??¨ê³¼?ìœ¼ë¡??„ë‹¬?˜ê¸° ?„í•´ ë¹ ë¥¸ ?¥ë©´ ?„í™˜ê³??œê°?ì¸ ?”ì†Œë¥??œìš©?˜ì—¬ ?¸í¬ê·¸ë˜???•íƒœ???ìƒ???œì‘?ˆìŠµ?ˆë‹¤. ê³µì‹ ?´ë?ì§€???±ì¥?˜ëŠ” ìºë¦­?°ë“¤??Illustratorë¥??œìš©??ë¦¬ê¹…??ê°€?¥í•œ ìºë¦­???•íƒœë¡??œì‘?˜ì—¬ ?ìƒ???œìš©?ˆìœ¼ë©? ?´ë²¤?¸ì? ê´€?¨ëœ ?Œë ¤ì§??”ì†Œ?¤ì„ ?€?´ê¸°êµ??´ë?ì§€ë¡?êµ¬ì„±?˜ì—¬ ?œê°?ì¸ ?¬ë?ë¥??”í–ˆ?µë‹ˆ??\n\n?í•œ ?¼ë? ?¥ë©´?ì„œ??AIë¥??œìš©?˜ì—¬ ?œì‘???´ë?ì§€ë¥??ìƒ?¼ë¡œ ë§Œë“¤???¤ì–‘???œê° ?”ì†Œë¥??œìš©???¸í¬ê·¸ë˜??ì½˜í…ì¸ ë¡œ ?„ì„±?ˆìŠµ?ˆë‹¤.",
...
// 2. ê·???ì¶”ê? ?ìƒ ?‘ì—…ë¬??°ì´??
const otherProjects = [
  { id: 101, title: "?¨ë¦¬??AI ê³µëª¨??ì°¸ì—¬ ?ìƒ", videoUrl: "/videos/?¨ë¦¬???•ìˆ˜ê¸°ì? ?¨ê»˜ ?˜ëŠ” ?˜í•˜ë£¨ì˜ ?„í™˜?â€?ê²½ì¢…ë¯?mp4" },
  { id: 102, title: "ì½”ë‚œ AI ?¤ì‚¬???ìƒ", videoUrl: "/videos/ì½”ë‚œ?¤ì‚¬??ê²½ì¢…ë¯?mp4" },
  { id: 103, title: "? íŠœë¸??‘ì‚°???¼ì¸  ?ìƒ", videoUrl: "/videos/? íŠœë¸Œì‡¼ì¸ ìˆ˜??mp4" },
...
export default function PortfolioPage() {
  ...
  const [selectedGif, setSelectedGif] = useState<string | null>(null); // GIF ?ì—…???íƒœ ì¶”ê?
  const [selectedVideo, setSelectedVideo] = useState<{ url: string; title: string; } | null>(null); // ë¹„ë””???ì—…???íƒœ ì¶”ê?

  // ?„ì—­ ?´ë²¤??ë¦¬ìŠ¤??(?¤ë” ??About ???¸ë? ?´ë¦­?ì„œ ëª¨ë‹¬ ?´ê¸°??
  useEffect(() => {
  ...
  // ?¤í¬ë¡??„ì¹˜???°ë¼ ?„ì¬ ?œì„±?”ëœ ?„ë¡œ?íŠ¸ ?¸ë±???…ë°?´íŠ¸
  useEffect(() => {
    const observerOptions = {
      root: null,
      rootMargin: "-45% 0px -45% 0px", // ?”ë©´ ì¤‘ì•™ 10% ?ì—­???¤ì–´????ê°ì?
      threshold: 0,
    };
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
          {projects.map((project, idx) => (
            ...
            >
              {/* Thumbnail Container (???ìƒ ?ì—… ?„ìš°ê¸?/ ?¸ë„¤???´ë?ì§€ ë³´ì—¬ì£¼ê¸°) */}
              <div 
              ...
              {/* Info Container (?´ë‹¹ ?„ë¡œ?íŠ¸ ?ì—­?¼ë¡œ ë¶€?œëŸ½ê²??¤í¬ë¡? */}
              <div 
              ...
              >
                <div className="flex flex-wrap gap-2 mb-1">
                  {project.tools.slice(0, 2).map(tool => ( // ?´ì? ?ê°œê¹Œì?ë§?ê°„ëµ?˜ê²Œ ?œì‹œ
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              ...
              {activeIndex === 3 && (
                <span className="text-foreground/50 font-medium text-sm md:text-base tracking-wide border-l border-foreground/20 pl-3">
                  ????ë§¤ê²½ë¯¸ë””??AI ?ìƒ ê³µëª¨??ì¶œí’ˆ??
                </span>
              )}
              {activeIndex === 4 && (
                <span className="text-foreground/50 font-medium text-sm md:text-base tracking-wide border-l border-foreground/20 pl-3">
                  PLAVE ??BBUU! ?Œì•… ê¸°ë°˜ ?€?´í¬ê·¸ë˜???ìƒ
                </span>
              )}
              {activeIndex === 5 && (
                <span className="text-foreground/50 font-medium text-sm md:text-base tracking-wide border-l border-foreground/20 pl-3">
                  ?´ë²¤???•ë³´ë¥??„ë‹¬?˜ëŠ” ê²Œì„ ?¸í¬ê·¸ë˜???ìƒ
                </span>
              )}
            </div>
              ...
              {[0, 1, 2, 3].map((i) => {
                ...
                return (
                  <div 
                    ...
                    onClick={() => {
                      if (gifSrc) setSelectedGif(gifSrc); // GIF ?¤í¬ë¦°ì´ ?´ë¦­?˜ë©´ ?ì—… ?´ê¸°
                    }}
                  >
                    {/* ë¹?ê³µê°„????ë³´ì—¬ì¤?Placeholder */}
                    {!gifSrc && (
    ...
    <section id="contact-section" className="relative w-full min-h-[80vh] flex flex-col items-center justify-center overflow-hidden bg-background border-t border-foreground/5 mt-24">
      ...
      <div className="absolute bottom-8 text-center w-full">
        <p className="text-sm text-foreground/30 font-medium tracking-widest uppercase">
          Â© {new Date().getFullYear()} JONGMIN KYOUNG. All rights reserved.
        </p>
      </div>
    </section>
              ...
              <div className="flex flex-col gap-6">
                <div className="group flex items-center gap-4 p-4 rounded-2xl bg-foreground/5 hover:bg-foreground/10 transition-colors cursor-default border border-transparent hover:border-foreground/10">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-xl font-bold tracking-tight text-foreground">ê²½ì¢…ë¯?/span>
                  </div>
                </div>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6 md:p-10 hide-scrollbar">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-max">
                {/* 
                  1. ë©”ì¸ projects ?”ì†Œë¥?ë§??ì—
                  2. otherProjects ?”ì†Œë¥??¤ì— ë¶™ì¸ ë°°ì—´???œìš©
                */}
